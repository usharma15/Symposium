...
const expectedCanaries = [
  ...
  "symposium-canary.spec.ts\0opens Notes drafts at the top and returns from quoted posts to the exact Office view",
  "symposium-canary.spec.ts\0shows every saved post and comment and organizes the Office library",
  ...
  "symposium-canary.spec.ts\0aligns post and comment detail content to one responsive rail",
