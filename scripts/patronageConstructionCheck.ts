...
assert.match(patronageStyles, /\.patronage-side-inline > \.patronage-side[\s\S]*position: static;[\s\S]*max-height: calc\(100vh - 112px - var\(--symposium-side-rail-bottom-clearance\)\)/);
