...
assert.match(patronageStyles, /\.patronage-side-inline > \.patronage-side[\s\S]*position: static;[\s\S]*max-height: calc\(100vh - var\(--symposium-detail-top\) - var\(--symposium-side-rail-bottom-clearance\)\)/);
